        ...
        <div class="block clearfix">
            <div class="AreaL">
                ...
                <div id="category_tree" class="box_1">
                    <?php if(is_array($brand_data)): $i = 0; $__LIST__ = $brand_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dl>
                        <dt><a href="#"><?php echo ($vo["brand_name"]); ?></a></dt>
                        <dd>       </dd>
            ...
            <div class="AreaR">
                ...
                <div class="box">
                    <div class="box_1">
                        ...
                        <div class="screeBox">
                            <strong>品牌：</strong>
                          <?php if($brand_id): ?><a href="/Home/Goods/goods_list/id/0/price/<?php echo ($price); ?>">全部</a>
                              <?php else: ?>
                              <span>全部</span><?php endif; ?>


                            <?php if(is_array($brand_data)): $i = 0; $__LIST__ = $brand_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($brand_id == $vo[id]): ?><a href="#"><span><?php echo ($vo["brand_name"]); ?></span></a>
                                    <?php else: ?>
                                    <a href="<?php echo U('Goods/goods_list',array('id'=>$vo[id],'price'=>$price));?>"><?php echo ($vo["brand_name"]); ?></a><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                        <div class="screeBox">
                            <strong>价格：</strong>
                            <?php if($price): ?><a href="/Home/Goods/goods_list/id/<?php echo ($brand_id); ?>/price/0">全部</a>
                                <?php else: ?>
                                <span>全部</span><?php endif; ?>

                            <?php if(is_array($price_data)): $i = 0; $__LIST__ = $price_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($price == $key): ?><a href="#"><span><?php echo ($vo); ?></span></a>&nbsp;
                                    <?php else: ?>
                                    <a href="/Home/Goods/goods_list/id/<?php echo ($brand_id); ?>/price/<?php echo ($key); ?>"><?php echo ($vo); ?></a>&nbsp;<?php endif; endforeach; endif; else: echo "" ;endif; ?>
                ...
                <div id="show_best_area" class="clearfix">
                    <?php if(is_array($goods_data)): $i = 0; $__LIST__ = array_slice($goods_data,2,5,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="goodsItem">
                        <a href="<?php echo U('goods_detail','id='.$vo[id]);?>"><img src="/Uploads/<?php echo ($vo["goods_smallpic"]); ?>" alt="<?php echo ($vo["goods_name"]); ?>" class="goodsimg"></a><br />
                        <p class="f1"><a href="<?php echo U('goods_detail','id='.$vo[id]);?>" title="<?php echo ($vo["goods_name"]); ?>"><?php echo ($vo["goods_name"]); ?></a></p>
                    ...
                    <div class="box_1">
                        ...
                        <form name="compareForm" action="compare.php" method="post" onsubmit="return compareGoods(this);">
                            <div class="clearfix goodsBox" style="border: medium none; padding: 11px 0pt 10px 5px;">
                                <?php if(is_array($goods_data)): $i = 0; $__LIST__ = $goods_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="goodsItem">
                                    <a href="<?php echo U('goods_detail','id='.$vo[id]);?>"><img src="/Uploads/<?php echo ($vo["goods_smallpic"]); ?>" alt="<?php echo ($vo["goods_name"]); ?>" class="goodsimg"></a><br />
                                    <p><a href="<?php echo U('goods_detail','id='.$vo[id]);?>" title="<?php echo ($vo["goods_name"]); ?>"><?php echo ($vo["goods_name"]); ?></a></p>
                                    <font class="market_s">￥<?php echo ($vo["goods_mprice"]); ?>元</font><br />
                                    <font class="shop_s">￥<?php echo ($vo["goods_price"]); ?>元</font><br />

            ...
            <div class="usBox clearfix">
                    ...
                    <form name="formLogin" action="" method="post">
                        <table align="left" border="0" cellpadding="3" cellspacing="5" width="100%">
                            <tbody><tr>
                                    ...
                                    <td width="85%"><input name="username" size="25" class="inputBg" type="text" value="<?php echo (cookie('username')); ?>"/></td>
                                </tr>
                                <tr>
                ...
                <div class="usTxt">
                    ...
                    <div style="padding-left: 50px;">
                        ...
                        3. 享受会员积分制度<br />
                        4. 订阅本店商品信息  <br />
                        <a href="<?php echo U('Login/reg');?>"><img src="/Public/Home/images/bnt_ur_reg.gif"></a>
                    </div>
                </div>
            </div>
            </div>

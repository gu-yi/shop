...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    #consignee_addr {width:450px;}
        ...
        <div class="block">
            <form action="<?php echo U('Order/buy_add');?>" method="post" name="theForm" id="theForm" >
                <div class="flowBox">
                    ...
                    <table cellpadding="5" cellspacing="1" width="99%">
                        <tbody><tr>
                            ...
                            <?php if(is_array($buy_data)): $i = 0; $__LIST__ = $buy_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                <td>
                                    <a href="#" target="_blank" class="f6"><?php echo ($vo["goods_name"]); ?></a>
                                </td>

                                <td><?php if(is_array($vo[goods_attr])): $i = 0; $__LIST__ = $vo[goods_attr];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i; echo ($key); ?>:<?php echo ($voo); ?><br /><?php endforeach; endif; else: echo "" ;endif; ?>
                                </td>
                                <td align="right">￥<?php echo ($vo["goods_mprice"]); ?>元</td>
                                <td align="right">￥<?php echo ($vo["goods_price"]); ?>元</td>
                                <td align="right"><?php echo ($vo["number"]); ?></td>
                                <td align="right">￥<?php echo ($vo["goods_total"]); ?>元</td>
                            </tr><?php endforeach; endif; else: echo "" ;endif; ?>

                            <tr>
                                <td colspan="7">
                                    购物金额小计 ￥<span><?php echo ($totals); ?></span>元<!--，比市场价 ￥6012.00元 节省了 ￥1002.00元 (17%) -->             </td>
                            </tr>
                        </tbody></table>
                </div>
                <div class="blank"></div>
                <div class="flowBox">
                    ...
                    <table cellpadding="5" cellspacing="1" width="99%">
                        <tbody><tr>
                                <td>收货人姓名:</td>
                                <td><?php echo ($lo_data["lo_name"]); ?></td>
                                <td>电子邮件地址:</td>
                                <td><?php echo ($lo_data["lo_emal"]); ?></td>
                            </tr>
                            <tr>
                                <td>详细地址:</td>
                                <td><?php echo ($lo_data["lo_address"]); ?> </td>
                                <td>邮政编码:</td>
                                <td>暂无</td>
                            </tr>
                            <tr>
                                <td>电话:</td>
                                <td><?php echo ($lo_data["lo_tel"]); ?> </td>
                                <td>手机:</td>
                                <td><?php echo ($lo_data["lo_tel"]); ?> </td>
                            </tr>
                            <tr>
               ...
               <!-- <div class="flowBox">
                ...
                <div class="flowBox">
                    ...
                    <div id="ECS_ORDERTOTAL">
                        <table cellpadding="5" cellspacing="1" width="99%">
                            <tbody><tr>
                                <td align="right">    该订单完成后，您将获得            <font class="f4_b"><span><?php echo ($totals); ?></span></font> 积分            ，以及价值               <font class="f4_b">￥0.00元</font>的红包。
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                        商品总价: <font class="f4_b">￥<span><?php echo ($totals); ?></span>元</font>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right"> 应付款金额: <font class="f4_b">￥<span><?php echo ($totals); ?></span>元</font>
                                    </td>
                                </tr>
                            </tbody></table>
                    </div>           <div style="margin: 8px auto;">
                    <!--传递数据使用隐藏域-->
                    <input type="hidden" name="order_data" value='<?php echo ($order_data); ?>'>
                    <input type="hidden" name="location_id" value="<?php echo ($lo_data["id"]); ?>">

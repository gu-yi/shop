    ...
    <body class="index_body">
        ...
        <div class="block">
            <div class="flowBox" style="margin: 0pt auto 70px;">
                <h6 style="text-align: center; height: 30px; line-height: 30px;">感谢您在本店购物！您的订单已提交成功，请记住您的订单号: <font style="color: red;"><?php echo ($data["order_number"]); ?></font></h6>
                <table style="border: 1px solid rgb(221, 221, 221); margin: 20px auto;" align="center" bgcolor="#ffffff" border="0" cellpadding="15" cellspacing="0" width="99%">
                    <tbody><tr>
                            <td align="center" bgcolor="#ffffff">
                                您选定的配送方式为: <strong><?php echo (getTatus($data[order_exp])); ?></strong>，您选定的支付方式为: <strong><?php echo (getPayTatus($data[order_pay])); ?></strong>。您的应付款金额为: <strong>￥<?php echo ($data["order_price"]); ?>元</strong>
                            </td>
                        </tr>
                        <tr>
                            <td align="center" bgcolor="#ffffff"><a href="<?php echo U('order/pay','oid='.$data['id']);?>" style="font-size: 26px;">立即支付</a></td>
                        </tr>
                    </tbody></table>

    ...
    <body>
        ...
        <div style="font-size: 13px; margin: 10px 5px;">
            <table class="table_a" border="1" width="100%">
                ...
                <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr id="product1">
                        <td><?php echo ($d["id"]); ?></td>
                        <td><a href="#"><?php echo ($d["goods_name"]); ?></a></td>
                        <td><?php echo ($d["goods_count"]); ?></td>
                        <td><?php echo ($d["goods_price"]); ?></td>
                        <td><img src="/Uploads/<?php echo ($d["goods_bigpic"]); ?>" height="60" width="60"></td>
                        ...
                        <td><a href="<?php echo U('goods/update','id='.$d['id']);?>">修改</a></td>
                        <td><a class="goods_del" data_id="<?php echo ($d["id"]); ?>" href="javascript:;" ><?php if($d["goods_status"] == 1): ?>下架<?php else: ?>上架<?php endif; ?></a></td>

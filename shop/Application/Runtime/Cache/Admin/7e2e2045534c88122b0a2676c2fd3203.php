...
<html>
    ...
    <body>
        <table cellspacing=0 cellpadding=0 width="100%" align=center border=0>
            <tr height=28>
                <td background=/Public/Admin//css/title_bg1.jpg>当前位置: </td></tr>
            <tr>
                <td bgcolor=#b1ceef height=1></td></tr>
            <tr height=20>
                <td background=/Public/Admin//css/shadow_bg.jpg></td></tr></table>
            ...
            <tr height=100>
                ...
                <td>
                    <table height=100 cellspacing=0 cellpadding=0 width="100%" border=0>
                        ...
                        <tr>
                            <td>当前时间：<?php echo (date('Y-m-d H:i:s',$date)); ?></td></tr>
                        <tr>
        ...
        <table cellspacing=0 cellpadding=0 width="95%" align=center border=0>
            ...
            <tr height=22>
                <td style="padding-left: 20px; font-weight: bold; color: #ffffff" 
                    align=middle background=/Public/Admin//css/title_bg2.jpg>您的相关信息</td></tr>
